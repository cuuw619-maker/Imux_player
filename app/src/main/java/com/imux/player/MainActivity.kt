        ...
        setContent {
            ...
            val picker = rememberLauncherForActivityResult(ActivityResultContracts.OpenDocumentTree()) { uri ->
                if (uri != null) {
                    ...
                    vm.addFolder(uri.toString(), DocumentFile.fromTreeUri(this, uri)?.name ?: "Music")
                }
            }
                ...
                if (!onboardingDone) {
                    Surface(Modifier.fillMaxSize()) {
                        Column(
                            ...
                            Text("A local-first music player built around your library.", style = MaterialTheme.typography.titleMedium, color = MaterialTheme.colorScheme.onSurfaceVariant)
                                ...
                                bottomBar = {
                                    Column {
                                        ...
                                        NavigationBar {
                                            ...
                                            NavigationBarItem(destination == AppDestination.Settings, { destination = AppDestination.Settings }, icon = { Icon(Icons.Default.Settings, null) }, label = { Text("Settings") })
                                        }
                                    }
                                }
                            ) { padding ->
